...
Error should be 37.4 and 4.3  (but with some variance because now we have 3 resetted layers with random weights)
"""
if False:
...
checkpoint_callback = ModelCheckpoint(
    monitor='val_mae',
    dirpath='checkpoints/experiments1/1_3',
...
for name, param in image_op_net.named_parameters():
    if 'mnist_net1.fc2' not in name and 'mnist_net1.fc1' not in name and 'operation_net.fc1' not in name:
